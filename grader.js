...
var cheerioUrl = function(url_result) {
   return cheerio.load(fs.readFileSync(url_result));
};

var getUrl = function(url_result, checksfile) {
$ = cheerioUrl(url_result);
};
...
if(require.main == module) {
    ...
    .option('-u, --url <url_result>', 'Url from command line', URL_DEFAULT) 
        .parse(process.argv);
